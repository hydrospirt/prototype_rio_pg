...
### 🔍 Небольшой лайфхак
Если вы хотите редактировать шаблон, перейдите в `password-generator/password_generator/utils/settings.py`

- 🤝 У вас есть вопрос? Связаться со мной можно в телеграмм: https://t.me/arcan1um
